...
def classify_from_transcript(text: str):
    ...
    buckets = {
        ...
        "flood": [
            "flood", "flooding", "water rising", "river overflow", "inundat","water overflow",
            "pani", "paani", "pani bhar", "paani bhar", "baadh", "baarh", "barish", "nadi", "talab", "dub", "doob", "dooba"
        ],
        "earthquake/building collapse": [
            "earthquake", "tremor", "aftershock", "collapsed", "collapse", "rubble", "debris", "crack","shaking","surface","floor",
